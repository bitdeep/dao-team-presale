...
// File: contracts\CommunityWhitelistRound.sol
...
contract TeamSeed is Ownable {
    ...
    function resetVest() external onlyOwner {
        ...
        require(getChainId() == 1 || getChainId() == 4002, "only test env");
